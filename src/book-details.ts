...
export class BookDetails extends ScopedElementsMixin(LitElement) {
    ...
    bookFromInput(): Book {
        return {
            ...
            category: (this as any).shadowRoot.getElementById('category').value,
            label: (this as any).shadowRoot.getElementById('label').value,
        }
    }
        ...
        return html`
            <div class="info">
                ...
                <div class="bookMeta">
                    ...
                    <div class="category"><input id="category" placeholder="category"  value=${this.book.category} /></div>
                    <div class="label"><input id="label" placeholder="label"  value=${this.book.label} /></div>
                </div>
            </div>
        ...
        return html`
            <div class="info" >
                ...
                <div class="bookMeta">
                    ...
                    <div class="category">${this.book.category}</div>
                    <div class="label">${this.book.label}</div>
                </div>
            </div>
